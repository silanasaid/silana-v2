...
// Automatically detect language based on code patterns
...
// Function to send code to the API and get an image
...
const handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  if (!text) {
    return m.reply(
      `Please enter code or reply to a message containing code.\nExample:\n*${usedPrefix}${command} console.log("Hello, World!");*`
    );
  }
